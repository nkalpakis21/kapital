    ...
    <footer className="w-full bg-gray-50 py-8 md:py-12">
      <div className="container px-4 md:px-6">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link href="/lp/marketplace" className="text-gray-600 hover:text-gray-900 transition-colors">
                  Marketplace
                </Link>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-500">© {new Date().getFullYear()} Kapital. All rights reserved.</p>
